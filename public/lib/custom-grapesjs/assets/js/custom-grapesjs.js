...
const editor = grapesjs.init({
    ...
    canvas: {
        styles: [
            ...
            // app_url + "/theme/css/fontawesome.css",
            // app_url + "/theme/css/cookiealert.css",
            // app_url + "/theme/css/calendar.css",
            // "https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700|Roboto:300,400,500,700&display=swap",
            // app_url + "/theme/css/custom.css",
        ...
        scripts: [
            ...
            app_url + "/theme/js/photography-addons.js",

            app_url + "/theme/js/slick.js",
            app_url + "/theme/js/slick.extension.js",
            app_url + "/theme/js/cookiealert.js",
            // app_url + "/theme/js/jquery.calendario.js",
            // app_url + "/theme/js/events-data.js",
            app_url + "/theme/js/functions.js",
            app_url + "/theme/js/scripts/home.js",
        ],
    },
