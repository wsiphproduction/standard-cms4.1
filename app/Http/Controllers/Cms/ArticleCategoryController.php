...

{
...

    {
        ...
        $newData['slug'] = ModelHelper::convert_to_slug(ArticleCategory::class, $newData['name'])[0];
...

    {
        ...
        foreach ($pages as $page) {
            ...
            $articleCategory = ArticleCategory::find($page);
            ...
            if ($articleCategory) {
                ...
                $articleCategory->update(['user_id' => $userId]);
