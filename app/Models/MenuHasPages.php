...
class MenuHasPages extends Model
{
    use SoftDeletes;

    protected $table = 'menu_has_pages';
...
//        }
    ...
    {
        return $this->hasMany(MenuHasPages::class, 'parent_id', 'id')->orderBy('page_order', 'asc');
    }

	public function sub_pages_by_order()
    {
        return $this->sub_pages()->orderBy('page_order', 'asc')->get();
    }

    public function parent_page()
    {
        return $this->hasOne(MenuHasPages::class, 'id', 'parent_id');
    }
    ...
    {
        return MenuHasPages::validator()->fails();
    }

    public static function get_error_messages()
    {
        return MenuHasPages::validator()->messages();
    }
}
