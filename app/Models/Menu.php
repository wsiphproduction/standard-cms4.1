...
class Menu extends Model
{
    ...
    {
        return $this->belongsToMany(Page::class, 'menu_has_pages');
    }

    public function navigation()
    {
        return $this->hasMany(MenuHasPages::class);
    }
    ...
    {
        return $this->navigation()->where('parent_id', 0)->orderBy('page_order', 'asc')->get();
    }
